...
- Minimale Dokumentationsstruktur mit nur drei Promptotyping-Dokumenten (CLAUDE-1.md, DATA.md, DESIGN.md); mehr Vibe Coding als Promptotyping
...
- CLAUDE-1.md (A) — Dokumentation des Standes für das LLM
...
Data exploration (dual interface paradigm: search + spatial exploration)