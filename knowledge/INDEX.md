...
- **[paper-draft.md](paper-draft.md)** — the integrated final version of 2026-07-29 (night intake), five sections with six embedded figures whose image files are adopted under `assets/figures/`. It becomes `paper.md` when the chapter-wise acceptance has run to the end; until then the site keeps rendering the canonical file.
