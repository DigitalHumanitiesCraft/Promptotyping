...
- **[paper-draft.md](paper-draft.md)** — the operator's externally revised manuscript (Fassung 4, intake 2026-07-30), a condensation of the integrated final version of 2026-07-29. Five chapters; the figure placeholders await re-mapping to the adopted image files under `assets/figures/`, the loss control of the external revision is recorded in `intake-diff-2026-07-30.md`. It becomes `paper.md` when the chapter-wise acceptance has run to the end; until then the site keeps rendering the canonical file.
