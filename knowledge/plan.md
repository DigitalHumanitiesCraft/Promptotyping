...
Three teaching documents in the vault hold slide material that touches the tutorial's subject. The slide-text working document for the workshop series is `Teaching/Workshops/2026-07-14 Knowledge und Context Engineering Foliensatz.md`, a working document that carries the slide text, the speaker notes, and the provenance per slide across its six sections. The production version of the shorter course deck is `Teaching/Knowledge and Context Engineering (Foliensatz).md`, which numbers its slides 0 to 13 and adds an image concept and a figure sketch per slide. The derived workshop deck is `Teaching/Workshops/2026-07-18 - GDA Göttingen Workshop Folientexte.md`, which reuses its slides under the delta model of `Teaching/Slide Library.md`. Nothing else in the vault carries slide-level material on the six steps.
