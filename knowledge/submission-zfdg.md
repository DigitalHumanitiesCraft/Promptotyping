...
Digitale Forschungsdaten sind nur durch Software zugänglich, und generische Werkzeuge ebnen ein, was ein Projekt modelliert. Der Beitrag führt Promptotyping ein, iteratives, dokumentgetriebenes Context Engineering für agentische Coding-Werkzeuge, mit dem Forschende ihre Forschungsdaten in Forschungsartefakte übersetzen, meist Software, an die Daten eines Projekts gebunden. Versionierte Markdown-Dokumente tragen Anforderungen, Daten und Designentscheidungen, ein Agent leitet das Artefakt daraus ab. Modellieren, Spezifizieren und Verifizieren bleiben bei den Forschenden, formale Regeln validieren. Die Artefakte sind statische Web-Werkzeuge, darüber beginnt Research Software Engineering. Zwei Jahre dokumentierter Projekte bilden die Evidenz.

## Abstract englisch (max. 750 Zeichen)

Digital research data is accessible only through software, and generic tools flatten what a project has modelled. This paper introduces Promptotyping, document-driven context engineering for agentic coding tools, through which researchers translate research data into research artefacts, most often software bound to the data of one project. Versioned Markdown documents hold requirements, data descriptions, and design decisions, and an agent derives the artefact from them. Modelling, specifying, and verifying stay with the scholar, while formal rules validate. The artefacts are static web tools bounded by the handover point to Research Software Engineering. Roughly two years of documented projects provide the evidence.
...
6. Discussion (Prozess und Publikation; Verifikation und Validierung; Reproduzierbarkeit und Modellabhängigkeit; Grenzen; Übertragbarkeit)
7. Conclusion
