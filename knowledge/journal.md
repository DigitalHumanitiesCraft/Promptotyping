...
**Offen.** Der Begriff "Forschungsartefakt" selbst ist strittig, da im Feld weiter besetzt (Modelle, Ontologien, Workflows); drei Wege liegen vor, Engführung markieren, Gattung behalten und die Softwareklasse eigens benennen, oder Ersatzterminus. Namenskollision in 3.3: wenn alle Promptotyping Documents Wissensdokumente sind, ist "Knowledge Documents" als Untertypname doppelt belegt; Vorschlag ist die Umbenennung nach dem Modus (Declarative Documents), mit Folgekosten in Vorlagen und Repo. Ohne Beleg bleiben die Herleitung der Dokumenttypologie aus dem Knowledge Engineering und die Confabulation. Zum SUGW-Projekt (`chpollin/db_for_medieval_legal_transactions_edition`, Veröffentlichung angekündigt) ist offen, ob die geschulten Projektbeteiligten selbständig weiterarbeiten; davon hängt ab, ob 5.4 einen zweiten Drittnutzungsfall führt. Nicht besprochen sind die restlichen Begriffe ab der Interface-Typologie sowie die acht verbliebenen Hilfsbegriffe, unter denen die Verifikation die größte Reichweite hat, weil sie im Paper auf drei Ebenen läuft (Verifikationsebenen 6.2, Verification Document 3.3, Verification Interface 4.2).
