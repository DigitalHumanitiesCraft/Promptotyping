...
Offene Entscheidungen: **E1** Venue; Tendenz DH-Journal (Operator 2026-07-23). Erstbefund der Venue-Recherche 2026-07-23: DHQ (Diamond OA, rolling; zusätzlich Special Issue Critical Code Studies mit LLM-Coding-Bezug, Deadline zu prüfen), International Journal of Digital Humanities (Springer, Methodenfokus), DSH (Oxford, etabliert, Paywall), TGDK Special Issue "Semantic Digital Humanities" (Diamond OA, Deadline 2027-01-31, passt nur über die Semantic-Web-Linie des Papers, KG-zentriert), Computational-Humanities-Research-Umfeld zu prüfen; DH2026-Konferenz läuft bereits (Juli 2026), DHd 2027 deutschsprachig. Vertiefung in der Venue-/Novelty-Recherche vor der Entscheidung. **E2** PRISM-Deck-Datierung (Zenodo-Snapshot oder GM-DH-Commit genügt). **E3** Blogpost-Einstieg (Alltags-Generalisierungsbeispiel). **E4** Machine-Review-Freigabe im Grounded Vault (Fremdfamilien-Mechanismus laut `vault/knowledge/specification.md`).
