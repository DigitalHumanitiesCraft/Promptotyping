...
# The SZD-HTR repository's FAIR4RS audit of 2026-07-23 found accessibility and reusability largely fulfilled and findability unfulfilled.

## Statement

A criterion-by-criterion audit of the SZD-HTR repository against the FAIR4RS principles v1.0, run on 2026-07-23, found accessibility fulfilled by construction, reusability largely fulfilled with detailed provenance as the strongest point, and every findability principle unfulfilled at the snapshot; the audit's verdict names the findability gap publication work. This is the audit the paper's FAIR4RS passage rests on.
