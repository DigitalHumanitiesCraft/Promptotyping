...
| berners-lee-2025 | Berners-Lee 2025, This Is for Everyone | 2.3 | B | acquisition open | | no legitimate open copy; publisher essay carries the personal-agent line but not the agent-realisation claim; print copy needed. 2026-07-25: the operator received the book as an audiobook, which yields no citable locator, so the paper sentence was cut back to what the publisher essay carries |
