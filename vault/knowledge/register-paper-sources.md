...
| edge-2024 | Edge et al. 2024, GraphRAG | fn [^kg] (2.3) | A | csl | | arXiv preprint, cited for graph-based retrieval answering corpus-level questions; the footnote deliberately stays a pointer and opens no evaluation discussion |
...
| geiger-2023 | Geiger 2023, Daten / Forschungsdaten (ZfdG Working Papers) | 2.3 | A | claimed | [[10_distillates/publications/geiger-2023-daten-forschungsdaten]] | research-data-is-defined-by-the-function-it-serves; the entry withholds a definition on purpose and carries the three functional selection criteria instead |
...
| kemman-2021 | Kemman 2021, Trading Zones | 1, 2.4 | A | claimed | [[10_distillates/publications/kemman-2021-trading-zones]] | digital-history-collaboration-is-a-trading-zone. Locator for the Galison attribution and the trading-zone definition: p. 4, held here rather than in the paper |
...
| pan-2024 | Pan et al. 2024, LLMs and Knowledge Graphs Roadmap | fn [^kg] (2.3) | A | csl | | IEEE TKDE survey, cited for the two-way coupling of models and knowledge graphs; pointer only, see edge-2024 |
| pichler-2022 | Pichler/Reiter 2022, Operationalization (Journal of Cultural Analytics) | 2.3 | A | claimed | [[10_distillates/publications/pichler-2022-operationalization]] | operationalisation-develops-a-measurement-for-a-concept |
...
| star-1989 | Star/Griesemer 1989, Boundary Objects | orphaned (was 2.4) | A | claimed | [[10_distillates/publications/star-1989-boundary-objects]] | boundary-objects-are-plastic-yet-robust-across-communities; concept removed from the paper 2026-07-25; the CSL record stays as the source record of the distillate and no longer has a References entry |
| summerfield-2025 | Summerfield 2025, These Strange New Minds | 2.5 | C | csl | | trade book; source of the confabulation term for LLM output, received by the operator as an audiobook (2026-07-25), which yields no citable locator, so the paper cites the work without page |
