...
Spec Kit is the Spec-Driven-Development framework the paper names by title. Its own documentation fixes what the framework claims for its artefact set, its verification arrangement, its role model and its intended readership, and therefore bounds what the delimitation may assert about it.
