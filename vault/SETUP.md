...
1. **Topic and topic backbone** — the controlled list of topics; each becomes one `MOC-<Topic>.md` in `30_assertions/`.
...
3. Create one `MOC-<Topic>.md` per backbone topic in `30_assertions/` (schema in `knowledge/schema.md` § Topic map).
