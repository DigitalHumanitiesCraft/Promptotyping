...
Abgrenzung zu `Grenzen`: `Grenzen` benennt strukturelle Auslassungen ("Zeitraum 1418 bis 1447 ist nicht ausgewertet"), `Verzerrungen` benennt asymmetrische Abdeckungen innerhalb des erfassten Materials ("innerhalb der erfassten Personen sind Frauen mit beruflichen Netzwerken zu Männern überrepräsentiert").
...
- Grenzen: was das Material strukturell nicht abdeckt, also geschlossene Bestände, nicht digitalisierte Teile, bewusste Selektion.
