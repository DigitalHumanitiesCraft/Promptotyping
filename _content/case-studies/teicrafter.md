...
Section 2.5 of the paper withholds the mapping of a single method component onto a single project of this phase, because the vocabulary postdates the practice it names. Naming teiCrafter the origin point is the one attribution the paper makes explicitly, and the case supports nothing beyond it.
