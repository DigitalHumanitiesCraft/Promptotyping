...
The LLM-as-a-judge step in the hybrid validation ranks below human verification for the reasons Section 2.3.1 of the paper gives, since the documented biases of that arrangement apply here. Everything the deterministic rules cannot reach inherits that caveat.
